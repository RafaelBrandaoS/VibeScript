...
"""
    ...
    *   ADICIONAR OS FAVICONS EM TODAS AS PÁGINAS
    *   CONFIGURAR OS LINKS QUE ESTÃO ERRADOS
    *   TIRAR O TELEFONE DO FORMULÁRIO DE CADASTRO
    *   ADICIONAR AS CONFIGURAÇÕES DA CONTA DO USUÁRIO
    *   MELHORAR O RESPONSSIVO DAS PÁGINAS
    *   ADICIONAR O BUTÃO DE MOSTRAR OU OCULTAR A SENHA
